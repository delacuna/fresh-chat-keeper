...
**Fresh Live Chat Chrome Extension**
...
Fresh Live Chat は個人を特定できる情報を一切収集しません。
...
- API リクエストは Fresh Live Chat が管理する軽量プロキシ経由で行われます。
...
Fresh Live Chat はユーザーデータを第三者に販売・共有することは一切ありません。

### 問い合わせ

ご質問は [GitHub リポジトリの Issues](https://github.com/delacuna/spoilershield/issues) または [delacunaworks@gmail.com](mailto:delacunaworks@gmail.com) までお問い合わせください。
...
Fresh Live Chat does not collect any personally identifiable information.
...
When performing spoiler detection (Stage 2), Fresh Live Chat sends YouTube chat comment text to the Anthropic Claude API.
...
- API requests are made through a lightweight proxy managed by Fresh Live Chat.
...
Fresh Live Chat does not sell or share user data with any third parties.

### Contact

For questions, please open an issue on the [GitHub repository](https://github.com/delacuna/spoilershield/issues) or contact us at [delacunaworks@gmail.com](mailto:delacunaworks@gmail.com).
